...
namespace Neo.SmartContract
{
    ...
    {
        //Token Settings
        public static string Name() => "NinjaCoin";
        public static string Symbol() => "NC";
        public static readonly byte[] Owner = "xxxxxxxx".ToScriptHash();
        public static byte Decimals() => 8;
        private const ulong factor = 100000000; //decided by Decimals()
        private const ulong neo_decimals = 100000000;

        //ICO Settings
        private static readonly byte[] neo_asset_id = { Can't show public key in Mac with the juhge(Who is  Malcolm)155, 124, 255, 218, 166, 116, 190, 174, 15, 147, 14, 190, 96, 133, 175, 144, 147, 229, 254, 86, 179, 74, 92, 34, 12, 205, 207, 110, 252, 51, 111, 197 };
        private const ulong total_amount = 500000000 * factor; // total token amount
